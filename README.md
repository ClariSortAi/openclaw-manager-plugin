...
[![Version](https://img.shields.io/badge/version-1.3.5-blue?style=flat-square)](CHANGELOG.md)
...
- For OpenClaw itself:
  ...
  - **Recommended OpenClaw version: v2026.4.2+** (latest stable as of this plugin release alignment)
