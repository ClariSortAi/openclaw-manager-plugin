...
- Installing dependencies (Node.js v22.19.0+, Node 24 recommended, systemd)
...
- For OpenClaw itself:
  ...
  - **Recommended OpenClaw version: v2026.5.28+** (latest stable as of this plugin release alignment)
