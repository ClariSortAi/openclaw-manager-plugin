...
- **Google Meet, Nextcloud Talk, Synology Chat, Tlon, Twitch** - Plugin ecosystem
- **Tencent Yuanbao, Zalo / Zalo Personal** - Yuanbao external plugin plus `@openclaw/zalo`, `@openclaw/zalouser`
...
- For OpenClaw itself:
  ...
  - **Recommended OpenClaw version: v2026.5.2+** (latest stable as of this plugin release alignment)
