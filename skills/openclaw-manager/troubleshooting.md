...
```bash
# 1. Quick status (check version is v2026.3.1+, recommend v2026.5.4+)
openclaw status
...
Before troubleshooting anything else, verify you are on **v2026.3.1 or later** (recommend **v2026.5.4+**):
