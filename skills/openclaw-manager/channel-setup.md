...
### Slack Interactive Reply Directives (v2026.3.13+; expanded in v2026.3.24 and approvals/hardening through v2026.4.12)
...
As of v2026.4.7, channels that already require mention can additionally require explicit `@bot` mentions inside active threads:
```bash
