...
### Slack Interactive Reply Directives (v2026.3.13+; expanded through v2026.4.5)
...
As of v2026.4.5, per-channel `contextVisibility` controls can further limit supplemental quote/thread/history context exposure:
```bash
