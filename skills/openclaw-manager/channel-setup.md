...
As of v2026.5.28-v2026.6.1, Slack delivery keeps final replies stable during late cleanup, suppresses leaked reasoning payloads before delivery/accounting, and benefits from the broader channel timeout/retry bounding in the stable line.
...
In v2026.5.18-v2026.6.1, isolated topic lanes, durable send-message actions, default-account preservation, progress/final preview recovery, topic-name caches, and media/forum-topic delivery received additional stable fixes.
...
- v2026.6.2-beta.1+ improves polling stop/reset boundaries and admin writeback checks, but treat those as prerelease-only until a stable tag ships.
