...
### Slack Interactive Reply Directives (v2026.3.13+; expanded in v2026.3.24 and v2026.4.x)
...
As of v2026.4.7, Slack can enforce explicit mentions in bot-participated threads via `channels.slack.thread.requireExplicitMention`.
As of v2026.4.8-v2026.4.9, proxy/socket/media handling is hardened (Socket Mode proxy env handling plus safer Slack file redirect auth behavior), reducing silent DM/media delivery failures in proxy-heavy environments.
