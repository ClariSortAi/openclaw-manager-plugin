...
### Slack Interactive Reply Directives (v2026.3.13+; expanded through v2026.4.1)
...
As of v2026.4.1, native approval routing and durable `allow-always` trust behavior are more consistent across Slack/Discord remote exec flows, reducing false timeout and disabled-state edge cases.
