...
### Slack Interactive Reply Directives (v2026.3.13+; expanded in v2026.3.24, v2026.3.31-v2026.4.2, v2026.4.14, and v2026.5.4)
...
As of v2026.5.4, Slack progress drafts can render as Block Kit with `streaming.progress.render: "rich"`, resumed parent `message.send` calls keep their originating Slack thread context, and successful visible threaded sends record bot thread participation so unmentioned replies in bot-participated threads continue as documented.
