...
### Slack Interactive Reply Directives (v2026.3.13+; expanded in v2026.3.24, v2026.3.31, and v2026.4.x)
...
As of v2026.4.5, channel `contextVisibility` controls (`all`, `allowlist`, `allowlist_quote`) are available to further restrict supplemental quote/thread/history context passed to agents.
