...
`v2026.4.10+` note: if you use self-hosted/private-network OpenAI-compatible endpoints, set `models.providers.<provider-id>.request.allowPrivateNetwork true` explicitly for trusted internal hosts.
