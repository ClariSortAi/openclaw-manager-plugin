...
`v2026.4.8+` note: packaged bundled channel/plugin compatibility sidecars were realigned; if npm/global installs fail to boot bundled channels after update, run `openclaw doctor --fix` and verify CLI/runtime versions match.
