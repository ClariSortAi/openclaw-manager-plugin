---
description: Intelligent OpenClaw installation, configuration, and management assistant. Use when the user asks about installing OpenClaw, configuring channels (Slack, WhatsApp, Telegram, Discord), troubleshooting gateway issues, managing cron jobs, setting up security, or any OpenClaw-related task.
