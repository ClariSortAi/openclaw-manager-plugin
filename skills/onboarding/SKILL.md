...
- If the user is on a version older than v2026.3.1 (minimum safe version), make **upgrading** Milestone 0 before anything else; recommend v2026.6.1+ for current stable functionality.
