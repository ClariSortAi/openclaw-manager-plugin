...
- If the user is on a version older than v2026.3.1 (minimum safe baseline), make **upgrading** Milestone 0 before anything else. Recommend v2026.5.22+ for current stable guidance.
