...
### Added
- Added prerelease-watch coverage for upstream `v2026.5.16-beta.7`, including beta Node 22.19 floor awareness, typed tool-plugin authoring commands, HTTPS managed proxy CA trust, runtime-neutral image apt package build arg, browser dialog handling, channel/restart reliability notes, and plugin/message API deprecation pressure.
