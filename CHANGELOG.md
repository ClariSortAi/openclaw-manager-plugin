...
### Added
- Added TweetClaw plugin guidance for X/Twitter automation, including its verified ClawHub install command, npm fallback, onboarding goal mapping, credential placement, and reviewed posting reminders.
